...
class PRU(BaseMetric):
    ...
    def __init__(self, recommendations, config, params, eval_objects):
        ...
        self._asc_sorted_pop_items = dict(sorted(self._pop_items.items(), key=operator.itemgetter(1), reverse=False))
        pass
    ...
    def __pru(self, user_recommendations, cutoff):
        ...
        return -sp.stats.spearmanr(self.__rec_popularity__(user_recommendations[:cutoff], self._pop_items),
